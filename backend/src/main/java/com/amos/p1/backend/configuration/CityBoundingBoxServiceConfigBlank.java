...
@Component
@Profile("blank")
public class CityBoundingBoxServiceConfigBlank implements CityBoundingBoxServiceConfig{

    private static final Logger log = LoggerFactory.getLogger(CityBoundingBoxServiceConfigBlank.class);

    public CityBoundingBoxServiceConfigBlank(){
        log.info("Using CityBoundingBox Service Config for blank");
